...
The ES2021 (ES12) will be released in the middle of 2021. In this tutorial, you will learn about the five most interesting features from this specification: `String.prototype.replaceAll()`, numeric separators, logical assignment operators, `Promise.any()`, `WeakRef` and Finalizers.<!--more-->
<!--
Table of Contents:
